...
/*******
 * <p> Title: GUIDeleteUsersPage Class. </p>
 * 
...
public class ViewDeleteUsers {
	...
	*/
	...
	private static ViewDeleteUsers theView;	// Used to determine if instantiation of the class
												// is needed
	...
	public static Scene theDeleteUsersScene = null;	// The Scene each invocation populates
	protected static String theSelectedUser = "";	// The user whose roles are being updated
	protected static String confirmation = ""; 		// Yes or no confirmation for deletion
	...
	*/
	...
	/**********
	 * <p> Method: displayDeleteUsers(Stage ps, User user) </p>
	 * 
	...
	public ViewDeleteUsers() {
		...
		theDeleteUsersScene = new Scene(theRootPane, width, height);
		...
		// GUI Area 1
		label_PageTitle.setText("Delete a User Page");
		...
		ViewDeleteUsers.button_AddRole.setOnAction((event) -> 
			{ControllerDeleteUsers.performDeleteUser(); });
